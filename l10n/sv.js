OC.L10N.register(
    "epubreader",
    {
    "Settings updated successfully." : "Inställningarna sparades.",
    "EPUB/CBZ/PDF ebook reader" : "E-boksläsare för EPUB/CBZ/PDF",
    "A multi-format browser-based ebook reader, supports EPUB and CBR/CBZ" : "En webbläsarbaserad e-boksläsare som stöder formaten EPUB och CBR/CBZ",
    ...
    "custom font" : "Anpassat teckensnitt",
    "monospace" : "monospace",
    "font size" : "teckenstorlek",
    "font weight" : "teckensnittsvikt",
    "Use custom colors" : "Använd anpassade färger",
    "night mode can be toggled by clicking the book title" : "du kan växla mellan dag-/nattläge genom att klicka på boktiteln",
    "reflow text when sidebars are open" : "flöda om när sidopaneler är öppna",
    "disable extra-wide page turn areas" : "stäng av extra breda sidbläddringsytor",
    "show page turn arrows" : "visa sidbläddringspilar",
    "menu" : "meny",
    "Reader" : "E-boksläsare",
    "Select file types for which Reader should be the default viewer." : "Välj vilka format E-boksläsaren ska användas för. ",
    "Epub" : "ePub",
    "PDF" : "PDF",
    "CBR/CBZ" : "CBR/CBZ"
},
