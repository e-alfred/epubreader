OC.L10N.register(
    ...
    "EPUB/CBZ/PDF ebook reader" : "Bralnik datotek EPUB/CBZ/PDF",
    "A multi-format browser-based ebook reader, supports EPUB and CBR/CBZ" : "Spletni bralnik elektronskih knjig s podporo za zapisa EPUB in CBR/CBZ",
    ...
    "custom font" : "pisava po meri",
    "monospace" : "enotna širina",
    "font size" : "velikost pisave",
    "font weight" : "izris pisave",
    "Use custom colors" : "Uporabi barve po meri",
    "night mode can be toggled by clicking the book title" : "nočni način je mogoče preklopiti s klikom na naslov knjige",
    "reflow text when sidebars are open" : "ponovno postavi besedilo, ko so bočne orodne vrstice odprte",
    "disable extra-wide page turn areas" : "onemogoči polno-široka polja listanja strani",
    "show page turn arrows" : "pokaži puščice za listanje strani",
    "menu" : "Meni",
    "Reader" : "Bralnik",
    "Select file types for which Reader should be the default viewer." : "Izbor vrst datotek, ki naj bodo privzeto povezane z bralnikom.",
    "Epub" : "Epub",
    "PDF" : "PDF",
    "CBR/CBZ" : "CBR/CBZ"
},
