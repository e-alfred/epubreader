OC.L10N.register(
    ...
    "custom font" : "tilpasset skrift",
    "monospace" : "monospace",
    "font size" : "skriftstørrelse",
    "font weight" : "skriftvekt",
    "Use custom colors" : "Bruk tilpassede farger",
    "night mode can be toggled by clicking the book title" : "nattmodus kan byttes til ved å klikke på boktittelen",
    "reflow text when sidebars are open" : "tilpass tekstflyt på nytt når sidefelter er åpne",
    "disable extra-wide page turn areas" : "deaktiver ekstra brede sidevendingsområder",
    "show page turn arrows" : "vis sidevendingspiler",
    "menu" : "Meny",
    "Reader" : "Reader",
    "Select file types for which Reader should be the default viewer." : "Velg filtyper som Reader skal være standard visningsprogram for.",
    "Epub" : "Epub",
    "PDF" : ".PDF",
    "CBR/CBZ" : "CBR/CBZ"
},
