OC.L10N.register(
    ...
    "EPUB/CBZ/PDF ebook reader" : "کتابخوان EPUB/CBZ/PDF",
    "A multi-format browser-based ebook reader, supports EPUB and CBR/CBZ" : "یک خواننده کتاب الکترونیکی مبتنی بر مرورگر چند فرمتی، از EPUB و CBR/CBZ پشتیبانی می کند",
    ...
    "Use custom colors" : "از رنگ های سفارشی استفاده کنید",
    "night mode can be toggled by clicking the book title" : "حالت شب را می توان با کلیک کردن روی عنوان کتاب تغییر داد",
    "reflow text when sidebars are open" : "هنگامی که نوارهای کناری باز هستند، متن را دوباره جریان دهید",
    "disable extra-wide page turn areas" : "غیرفعال کردن مناطق چرخش صفحه بسیار گسترده",
    "show page turn arrows" : "نشان دادن فلش های چرخش صفحه",
    "menu" : "منو",
    "Reader" : "خواننده",
    "Select file types for which Reader should be the default viewer." : "انواع فایلی را انتخاب کنید که خواننده باید نمایشگر پیش فرض آنها باشد.",
    "Epub" : "Epub",
    "PDF" : "PDF",
    "CBR/CBZ" : "CBR/CBZ"
},
