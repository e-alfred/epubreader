OC.L10N.register(
    ...
    "A multi-format browser-based ebook reader, supports EPUB and CBR/CBZ" : "قارئ كتب الكترونية متعدد التنسيقات يعمل على متصفح الوب، ويدعم EPUB و CBR/CBZ.",
    ...
    "menu" : "القائمة ",
    "Reader" : "قارئ",
    "Select file types for which Reader should be the default viewer." : "عيّن أنواع الملفات التي يكون عليها الوضع التلقائي للقارئ.",
    "Epub" : "Epub",
    "PDF" : "PDF",
    "CBR/CBZ" : "CBR/CBZ"
},
